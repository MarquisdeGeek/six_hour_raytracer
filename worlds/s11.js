...
function makeWorldSection11() {
    ...
    const material_left   = new raytracer.materials.Dielectric(1.5);
    const material_bubble   = new raytracer.materials.Dielectric(1 / 1.5);
	...
	world.add(new Sphere(new raytracer.point3(-1, 0, -1), 0.4, material_bubble));
